...
class Tabs extends PureComponent {
  constructor(props) {
    super(props);
    this.onButtonHeandlerClick = this.onButtonHeandlerClick.bind(this);
    this.state = {
      activeTab: `Overview`,
    };
  }
  onButtonHeandlerClick(evt) {
  ...
  renderSwitch(activeTab, currentFilm) {
    switch (activeTab) {
      case `Overview`: return <React.Fragment>
        <div className="movie-rating">
          <div className="movie-rating__score">{currentFilm.rating}</div>
          <p className="movie-rating__meta">
            <span className="movie-rating__level">Very good</span>
            <span className="movie-rating__count">{currentFilm.rating} ratings</span>
          </p>
        </div>
        <div className="movie-card__text">
          <p>{currentFilm.description}</p>
          <p className="movie-card__director"><strong>Director: {currentFilm.director}</strong></p>
          <p className="movie-card__starring"><strong>Starring: {currentFilm.starring.map((elem) => elem).join(`,`)} </strong></p>
        </div>
      </React.Fragment>;

      case `Details`: return <React.Fragment>
          ...
          <div className="movie-card__text-col">
            ...
            <p className="movie-card__details-item">
              ...
              <span className="movie-card__details-value">
                {currentFilm.starring.map((elem) => elem).join(`,`)}
              </span>
            </p>
          </div>
          <div className="movie-card__text-col">
      ...
      case `Reviews`: return <React.Fragment>
      ...
      <nav className="movie-nav movie-card__nav">
        <ul className="movie-nav__list">
          <li className={activeTab === `Overview` ? `movie-nav__item  movie-nav__item--active` : `movie-nav__item`}>
            <a href="#" className="movie-nav__link" onClick={this.onButtonHeandlerClick}>Overview</a>
          </li>
          <li className={activeTab === `Details` ? `movie-nav__item  movie-nav__item--active` : `movie-nav__item`}>
            <a href="#" className="movie-nav__link" onClick={this.onButtonHeandlerClick}>Details</a>
          </li>
          <li className={activeTab === `Reviews` ? `movie-nav__item  movie-nav__item--active` : `movie-nav__item`}>
            <a href="#" className="movie-nav__link" onClick={this.onButtonHeandlerClick}>Reviews</a>
          </li>
        </ul>
      </nav>
      {this.renderSwitch(activeTab, currentFilm)};
    </React.Fragment>;
  }
}
Tabs.propTypes = {
