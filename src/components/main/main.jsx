...
class Main extends PureComponent {
  ...
  render() {
    ...
    const {onCardClickHendler, films, onButtonHendler} = this.props;
            ...
            <div className="movie-card__info">
              ...
              <div className="movie-card__desc">
                ...
                <div className="movie-card__buttons">
                  <Link to={RouteConst.PLAYER} className="btn btn--play movie-card__button" type="button">
                    <svg viewBox="0 0 19 19" width={19} height={19}>
                      <use xlinkHref="#play-s" />
                    </svg>
                    <span>Play</span>
                  </Link>
                  <Link to={RouteConst.MY_LIST} className="btn btn--list movie-card__button" type="button">
